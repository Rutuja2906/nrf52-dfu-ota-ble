...
#define DUMMY_DATA_SIZE 20480 // 20 KB of dummy data _firmware size exceeded the limit provided, so it is not not possible to build it.
...
int main(void)
{
	...
	LOG_INF("DFU firmware 10 - led blicking + 20kb dummy data\n");
