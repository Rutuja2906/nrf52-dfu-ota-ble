...
#define DUMMY_DATA_SIZE 10240 // 10 KB of dummy data _firmware size exceeded the limit provided, so it is not not possible to build it.
...
int main(void)
{
	...
	LOG_INF("DFU firmware 8 - led blicking + 10kb dummy data\n");
