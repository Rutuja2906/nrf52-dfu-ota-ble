...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUMGR_TRANSPORT_BT_AUTHEN, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BONDING_REQUIRED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_DEVICE_APPEARANCE, 832);
