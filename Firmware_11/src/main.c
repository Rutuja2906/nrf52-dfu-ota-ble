...
#define DUMMY_DATA_SIZE 25600 // 25 KB of dummy data _firmware size exceeded the limit provided, so it is not not possible to build it.
...
int main(void)
{
	...
	LOG_INF("DFU firmware 11 - led blicking + 25kb dummy data\n");
