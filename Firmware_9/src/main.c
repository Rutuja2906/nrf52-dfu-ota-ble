...
#define DUMMY_DATA_SIZE 15360 // 10 KB of dummy data _firmware size exceeded the limit provided, so it is not not possible to build it.
...
int main(void)
{
	...
	LOG_INF("DFU firmware 9 - led blicking + 15kb dummy data\n");
