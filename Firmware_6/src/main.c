...
#define DUMMY_DATA_SIZE 1024 // 1 KB of dummy data _firmware size exceeded the limit provided, so it is not not possible to build it.
...
int main(void)
{
	...
	LOG_INF("DFU firmware 6 - led blicking + 1kb dummy data\n");
